...
export const textPrimaryColorContrast = () => "#eee"; //Cor pra ficar atrás da primária
...
export const alwaysBlack = () => "#000";

// export const primaryColor = () => "#a00030";
// export const secondaryColor = () => " #5b6b13";
// export const textPrimaryColorContrast = () => "#eee";
// export const textSecondaryColorContrast = () => "#111";
// export const textPrimaryColorContrast = () => "#111";
// export const textSecondaryColorContrast = () => "#eee";
