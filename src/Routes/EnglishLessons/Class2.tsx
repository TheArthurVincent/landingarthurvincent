...
import { backDomain, getVideoEmbedUrl, pathGenerator, Xp } from "../../Resources/UniversalComponents";
import { HOne, HTwo, RouteDiv } from "../../Resources/Components/RouteBox";
import { ArvinButton } from "../../Resources/Components/ItemsLibrary";
import { Link } from "react-router-dom";
import { alwaysWhite, darkGreyColor, primaryColor, secondaryColor, textTitleFont, transparentBlack } from "../../Styles/Styles";
    ...
    <>
      <RouteDiv>
        ...
        >
          ...
          >{`${order + 1}- ${truncateTitle(theclass.title, 35)}`}</HOne>
          {nextclass ? (
            <span
              style={{
                color: secondaryColor(),
