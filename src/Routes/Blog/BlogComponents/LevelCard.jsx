...
export function LevelCard({ headers, _StudentId, picture, name, lastName }) {
  ...
  const seeScore = async (id) => {
    try {
      ...
      setLevel(
        response.data.totalScore >= 12000 && response.data.monthlyScore >= 3000 ? 1 :
          response.data.totalScore >= 25000 && response.data.monthlyScore >= 3000 ? 2 :
            response.data.totalScore >= 40000 && response.data.monthlyScore >= 3000 ? 3 :
              response.data.totalScore >= 60000 && response.data.monthlyScore >= 3000 ? 4 :
                response.data.totalScore >= 80000 && response.data.monthlyScore >= 3000 ? 5 :
                  response.data.totalScore >= 120000 && response.data.monthlyScore >= 3000 ? 6 :
                    response.data.totalScore >= 240000 && response.data.monthlyScore >= 3000 ? 7 :
                      response.data.totalScore >= 1200000 ? 8 : 0
      );
